...
/**
 * @program: crawler
 * @description: 贝壳--二手房--url 采集
 * @author: Mr.Chen
 * @create: 2019-09-04 20:06
 **/
@Component
public class CloudSecondHouseUrlBuss implements PageProcessor {
    @Resource
    @Qualifier("beikeSecondHouseUrlParse")
    private ParseData parseData;
    private Site site;
    public CloudSecondHouseUrlBuss() {
    }
    @Override
...
//        }
    ...
    public static void main(String[] args) {
        ...
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudSecondHouseUrlBuss.class)
                .aggregateEachAndRun();
    }
}
