...
/**
 * @program: crawler
 * @description: 贝壳--二手房--详情 采集
 * @author: Mr.Chen
 * @create: 2019-09-05 09:18
 **/
@Component
public class CloudSecondHouseDetailBuss implements PageProcessor {
    @Resource
    @Qualifier("beikeSecondHouseDetailParse")
    private ParseData parseData;
    private Site site;
    @Qualifier("beikeSecondHouseDetailPipeline")
    @Resource
    private Pipeline pipeline;
    public CloudSecondHouseDetailBuss() {
    }
    @Override
...
//        }
    ...
    public void aggregateEachAndRun(){
       ...
       /* HttpClientDownloader httpClientDownloader = HttpRequest.getMyHttpClientDownloader();
        ...
        sd.run();*/
        //2.不是代理时...
        Spider spider=Spider.create(this).thread(5).addPipeline(pipeline);
