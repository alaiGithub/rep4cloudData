...
/**
 * @program: crawler
 * @description: 房天下-新房-首页字段（核心几个链接和关键字段等...）--采集
 * @author: Mr.Chen
 * @create: 2019-09-06 16:54
 **/
@Component("cloudNewHouseOneDetailBuss")
public class CloudNewHouseOneDetailBuss implements PageProcessor{
    @Resource
    @Qualifier("fangNewHouseOneDetailParse")
    private ParseData parseData;
    @Qualifier("fangNewHouseOneDetailPipeline")
    @Resource
    private Pipeline pipeline;
    private Site site;
    public CloudNewHouseOneDetailBuss() {
    }
    @Override
...
//        }
    ...
    public static void main(String[] args) {
        ...
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudNewHouseOneDetailBuss.class)
                .aggregateEachAndRun();
    }
}
