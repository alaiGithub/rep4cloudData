...
/**
 * @program: crawler
 * @description: 房天下--新房--户型--采集...
 * @author: Mr.Chen
 * @create: 2019-09-07 14:46
 **/
@Component
public class CloudNewHouseFourDetailBuss  implements PageProcessor {
    @Resource
    @Qualifier("fangNewHouseFourDetailParse")
    private ParseData parseData;
    @Qualifier("fangNewHouseOneDetailPipeline")//留意下
    @Resource
    private Pipeline pipeline;
    private Site site;
    public CloudNewHouseFourDetailBuss() {
    }
    @Override
...
//        }
    ...
    public static void main(String[] args) {
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudNewHouseFourDetailBuss.class)
                .aggregateEachAndRun();
    }
}
