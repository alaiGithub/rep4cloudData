...
/**
 * @program: crawler
 * @description: 58--写字楼--地址--采集
 * @author: Mr.Chen
 * @create: 2019-09-10 14:41
 **/
@Component("cloudOfficeUrlBuss")
public class CloudOfficeUrlBuss implements PageProcessor {
    @Resource
    @Qualifier("sixteenthParseData")
    private ParseData parseData;
    private Site site;
    public CloudOfficeUrlBuss() {
    }
    @Override
...
//        //循环加入cookies
    ...
    public static void main(String[] args) {
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudOfficeUrlBuss.class)
                .aggregateEachAndRun();
    }
}
