...
/**
 * @program: crawler
 * @description: 房天下--新房楼盘--url 采集
 * @author: Mr.Chen
 * @create: 2019-09-06 15:35
 **/
@Component("cloudNewHouseUrlBuss")
public class CloudNewHouseUrlBuss implements PageProcessor{
    @Resource
    @Qualifier("fangNewHouseUrlParse")
    private ParseData parseData;
    private Site site;
    public CloudNewHouseUrlBuss() {
    }
    @Override
...
//        }
    ...
    public static void main(String[] args) {
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudNewHouseUrlBuss.class)
                .aggregateEachAndRun();
    }
}
