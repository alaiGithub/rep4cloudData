...
/**
 * @program: crawler
 * @description: 58--商铺--详情--采集
 * @author: Mr.Chen
 * @create: 2019-09-09 19:36
 **/
@Component("cloudShopDetailBuss")
public class CloudShopDetailBuss implements PageProcessor {
    @Resource
    @Qualifier("fifteenthParseData")
    private ParseData parseData;
    @Qualifier("cloudDataShopPipeline")
    @Resource
    private Pipeline pipeline;
    private Site site;
    public CloudShopDetailBuss() {
    }
    @Override
...
//        //循环加入cookies
    ...
    public static void main(String[] args) {
        ...
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudShopDetailBuss.class)
                .aggregateEachAndRun();
    }
}
