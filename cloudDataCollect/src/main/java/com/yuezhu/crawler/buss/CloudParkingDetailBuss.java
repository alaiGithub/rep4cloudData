...
/**
 * @program: crawler
 * @description: 58--停车位---数据采集
 * @author: Mr.Chen
 * @create: 2019-09-17 09:19
 **/
@Component("cloudParkingDetailBuss")
public class CloudParkingDetailBuss implements PageProcessor {
    @Resource
    @Qualifier("parkingDetailParse")
    private ParseData parseData;
    @Qualifier("cloudParkingSpacePipeline")
    @Resource
    private Pipeline pipeline;
    private Site site;
    public CloudParkingDetailBuss() {
    }
    @Override
...
//        //循环加入cookies
    ...
    public static void main(String[] args) {
        ...
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudParkingDetailBuss.class)
                .aggregateEachAndRun();
    }
}
