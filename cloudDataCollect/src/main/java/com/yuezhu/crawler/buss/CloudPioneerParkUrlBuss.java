...
/**
 * @program: crawler
 * @description: 好租--创业园--采集
 * @author: Mr.Chen
 * @create: 2019-09-17 20:44
 **/
@Component("cloudPioneerParkUrlBuss")
public class CloudPioneerParkUrlBuss implements PageProcessor{
    @Resource
    @Qualifier("pioneerUrlParseData")
    private ParseData parseData;
    private Site site;
    public CloudPioneerParkUrlBuss(){
    }
    @Override
...
//        //循环加入cookies
    ...
    public static void main(String[] args) {
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudPioneerParkUrlBuss.class)
                .aggregateEachAndRun();
    }
}
