...
/**
 * @program: crawler
 * @description: 贝壳租房-url采集(涉及的常量都是硬编码)
 * @author: Mr.Chen
 * @create: 2019-09-03 10:16
 **/
@Component
public class CloudRentHouseUrlBuss implements PageProcessor {
    @Resource
    @Qualifier("beikeRentHouseUrlParse")
    private ParseData parseData;
    private Site site;
    public CloudRentHouseUrlBuss() {
    }
    @Override
...
//        }
    ...
    public static void main(String[] args) {
        ...
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudRentHouseUrlBuss.class)
                .aggregateEachAndRun();
    }
}
