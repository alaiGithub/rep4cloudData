...
/**
 * @program: crawler
 * @description: 58--商铺--url--采集
 * @author: Mr.Chen
 * @create: 2019-09-09 17:38
 **/
@Component("cloudShopUrlBuss")
public class CloudShopUrlBuss  implements PageProcessor {
    @Resource
    @Qualifier("fourteenthParseData")
    private ParseData parseData;
    private Site site;
    public CloudShopUrlBuss() {
    }
    @Override
...
//        //循环加入cookies
    ...
    public static void main(String[] args) {
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudShopUrlBuss.class)
                .aggregateEachAndRun();
    }
}
