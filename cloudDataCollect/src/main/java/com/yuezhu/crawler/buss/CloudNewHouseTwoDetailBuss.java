...
/**
 * @program: crawler
 * @description: 房天下--新房--详情字段--采集
 * @author: Mr.Chen
 * @create: 2019-09-06 19:48
 **/
@Component("cloudNewHouseTwoDetailBuss")
public class CloudNewHouseTwoDetailBuss implements PageProcessor{
    @Resource
    @Qualifier("fangNewHouseTwoDetailParse")
    private ParseData parseData;
    @Qualifier("fangNewHouseOneDetailPipeline")//留意下
    @Resource
    private Pipeline pipeline;
    private Site site;
    public CloudNewHouseTwoDetailBuss() {
    }
    @Override
...
//        }
    ...
    public static void main(String[] args) {
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudNewHouseTwoDetailBuss.class)
                .aggregateEachAndRun();
    }
}
