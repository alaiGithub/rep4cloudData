...
/**
 * @program: crawler
 * @description: 58--写字楼--详情--解析
 * @author: Mr.Chen
 * @create: 2019-09-10 16:59
 **/
@Component("cloudOfficeDetailBuss")
public class CloudOfficeDetailBuss implements PageProcessor{
    @Resource
    @Qualifier("seventeenthParseData")
    private ParseData parseData;
    @Qualifier("cloudDataOfficePipeline")
    @Resource
    private Pipeline pipeline;
    private Site site;
    public CloudOfficeDetailBuss() {
    }
    @Override
...
//        //循环加入cookies
    ...
    public static void main(String[] args) {
        ...
        new ClassPathXmlApplicationContext("classpath:yuezhu/applicationContext*.xml").getBean(CloudOfficeDetailBuss.class)
                .aggregateEachAndRun();
    }
}
